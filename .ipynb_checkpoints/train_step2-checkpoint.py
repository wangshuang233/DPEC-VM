...
from Best_module.MUX_F import unet as net
import warnings
...
def cfg():
    ...
    parser.add_argument('--trainset', type=str, default='./datasets/LSRW/train', help='location of trainset')
    parser.add_argument('--testset', type=str, default='./datasets/LSRW/test', help='location of testset')
    parser.add_argument('--output', default='output', help='location to save output images')
    parser.add_argument('--modelname', default='MUX_LSRW', help='define model name')
    ...
    parser.add_argument('--weights_path', type=str, default="./models/MUX_LSRW_pre/best.pth", help='initial BEE weight')
